...
lista = [1,2,3,4] # Lista que se solicita para el llenado de información en las funciones.
...
def sum(list): #Se define la función de suma.
    ...
    print("La suma de la lista es: ", suma) #Imprime la suma total del bucle.

def mult(list): #Se define la función de multiplicación.
    multi = 1 #Se crea la variable multi inicializada con cero para almacenar la multiplicación de los valores.
    ...
    print("El total multiplicado es: ", multi) #Impime la multiplicación total el bucle.
